...
useEffect(() => {
  ...
  const fetchPredictions = (track: string, location: string) => {
    ...
    getWeekendPredictions(track, location)
      ...
      .catch(() => setError('Failed to fetch predictions. Make sure the backend is running.'))
  ...
  return (
    <div className="space-y-8">
      ...
      {[
        ...
        <div key={label} className="bg-zinc-900 border border-zinc-800 rounded-lg px-2 py-1 text-center min-w-[42px]">
