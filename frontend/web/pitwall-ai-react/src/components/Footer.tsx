export default function Footer() {
  return (
    <footer className="section-divider mt-12 sm:mt-16 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-2">
          <span className="text-red-500 font-black tracking-widest">PITWALL</span>
        ...
        <div className="text-left md:text-center">
          <p className="text-zinc-500 text-xs">
            Built with real 2026 F1 data · Predictions update after every session
          </p>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 border border-zinc-700 hover:border-red-500 text-zinc-400 hover:text-red-500 text-xs font-semibold px-3 py-2 rounded-xl transition-all"
          >
